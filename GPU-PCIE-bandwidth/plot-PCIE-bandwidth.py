...
fpath_list = fpath[fpath.find('bandwidth-')+10:fpath.rfind('KB')].split('_')
start = int( fpath_list[0] )
end = int( fpath_list[1] )
step = int( fpath_list[2] )
...
for count in range( Ncount ):
	...
	fpath = './figs/%dgpu-%.3d' % ( num_gpus, count )
