...
/*
__global__ void updateCPMLxE_smem(N3 N, P1F3 E, P1F3 H, P1F3 CE, float *psi1, float *psi2, int backward, float *RCMA, float *RCMB, int Npml) {
	int tk = threadIdx.x;
	...
	extern __shared__ float rcm[];
	float* rcma = (float*) rcm;
	float* rcmb = (float*) &rcma[Npml];
