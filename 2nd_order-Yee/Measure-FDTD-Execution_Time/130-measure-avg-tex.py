...
# prepare kernels
compile_opts = ['-Xptxas','-dlcm=ca']
mod1 = SourceModule( kernels1.replace('TPB',str(tpb)).replace('nyz',str(ny*nz)).replace('nx',str(nx)).replace('ny',str(ny)).replace('nz',str(nz)), options=compile_opts )
mod2 = SourceModule( kernels2.replace('TPB',str(tpb)).replace('nyz',str(ny*nz)).replace('nx',str(nx)).replace('ny',str(ny)).replace('nz',str(nz)), options=compile_opts )
mod3 = SourceModule( kernels3.replace('TPB',str(tpb)).replace('nyz',str(ny*nz)).replace('nx',str(nx)).replace('ny',str(ny)).replace('nz',str(nz)), options=compile_opts )
mod4 = SourceModule( kernels4.replace('Dx','16').replace('Dy','16').replace('nyz',str(ny*nz)).replace('nx',str(nx)).replace('ny',str(ny)).replace('nz',str(nz)), options=compile_opts )
mod5 = SourceModule( kernels5.replace('Dx','16').replace('Dy','16').replace('nyz',str(ny*nz)).replace('nx',str(nx)).replace('ny',str(ny)).replace('nz',str(nz)), options=compile_opts )
...
h4.prepare("PPPPPP", block=(16,16,1))
e4.prepare("PPPPPPPPP", block=(16,16,1))
e5.prepare("PPPPPP", block=(16,16,1), texrefs=[tcex,tcey,tcez])
...
measure_exec_time('2d block', e4.prepared_call, (nz/16,nx*ny/16), *ehc_args)
measure_exec_time('tex3D (16,16,1)', e5.prepared_call, (nz/16,nx*ny/16), *eh_args)
...
measure_exec_time('2d block', h4.prepared_call, (nz/16,nx*ny/16), *eh_args)
print '-'*47
