...
texture<double, 3, cudaReadModeElementType> tcex;
texture<double, 3, cudaReadModeElementType> tcey;
texture<double, 3, cudaReadModeElementType> tcez;

__global__ void update_e(int by0, double *ex, double *ey, double *ez, double *hx, double *hy, double *hz) {
	int tx = threadIdx.x;
	int ty = threadIdx.y;
	int bx = blockIdx.x;
	int by = blockIdx.y + by0;
