...
class Cylindrical:
    ...
    def side_main_func(self, x, grid1, grid2, axis, sign):
        ...
        out.append( self.side_func1(grid1, e_point1, e_point2, rc3, axis[1]) )
        out.append( self.side_func1(grid2, e_point1, e_point2, rc3, axis[2]) )
    ...
    def find_side_intersection_points(self, direction, grid1, grid2):
        if direction == 'x':
            axis = (0, 1, 2)
        elif direction == 'y':
            axis = (1, 0, 2)
        ...
        out1 = fsolve(self.side_main_func, x0=[0, 0, 0, 0, 0, 0], \
                args=(grid1, grid2, axis, +1), full_output=1)
