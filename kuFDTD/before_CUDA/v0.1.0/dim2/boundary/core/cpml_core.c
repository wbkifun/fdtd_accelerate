...
===============================================================================
*/
static char update_cpml_doc[] = "update_cpml(in_out_field, number_cells, update_field, base_field, cb, ds, npml, pml_coefficient, psi, pml_direction, pml_position)";
static char module_doc[] = \
	"module cpml_core:\n\
	update_cpml(in_out_field, number_cells, update_field, base_field, cb, ds, npml, pml_coefficient, psi, pml_direction, pml_position)";

static PyMethodDef cpml_core_methods[] = {
	{"update_cpml", update_cpml, METH_VARARGS, update_cpml_doc},
	{NULL, NULL, 0, NULL}
};
