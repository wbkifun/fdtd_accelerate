...
from kemp.fdtd3d.node import NodeDirectIncident, NodeFields, NodeGetFields
from kemp.fdtd3d import gpu, cpu


class TestNodeDirectIncident(unittest.TestCase):
    def __init__(self, args):
        super(TestNodeDirectIncident, self).__init__() 
        self.args = args
