...
from kemp.fdtd3d.gpu import DirectIncident, Fields
...
if __name__ == '__main__':
    ...
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (0, 1, 2), (0, 1, nz-3), False) ))
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (9, 0, 0), (9, 49, 59), True) ))
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (0, 0, 0), (39, 49, 59), True) ))
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (0, 27, 22), (29, 47, 53), True) ))
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (4, 8, 44), (4, 8, 44), False) ))
    suite.addTest(TestDirectIncident( (nx, ny, nz, 'ex', (4, 8, 44), (4, 8, 44), True) ))
    ...
    suite.addTests(TestDirectIncident(args) for args in test_list) 
