...
from kemp.fdtd3d.gpu import Fields, DirectSrc, GetFields, ExchangeFields, PbcExt
import numpy as np
import pyopencl as cl


nx, ny, nz = 100, 320, 320
tmax, tgap = 200, 10
divide_axes = 'x'
...
src = DirectSrc(fdtds[2], 'ez', (nx/2, ny/2, 0), (nx/2, ny/2, nz-1), lambda tstep: np.sin(0.1 * tstep))
