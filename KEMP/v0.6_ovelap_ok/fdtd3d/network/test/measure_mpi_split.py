...
from kemp.fdtd3d.gpu import Fields, CoreSplit3, CoreSplit2, IncidentDirect, GetFields
...
core = CoreSplit2(fields)
#exch = network.ExchangeMpiBlock(fields, core, direction)
#exch = network.ExchangeMpiNonBlock(fields, core, direction)
exch = network.ExchangeMpiSplit2(fields, core, direction)

#core = CoreSplit3(fields)
#exch = network.ExchangeMpiSplit3(fields, core, direction, tmax)
